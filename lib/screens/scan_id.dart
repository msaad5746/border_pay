        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.only(top: 43.04.h, bottom: 32.h),
                child: Center(
                  child: SizedBox(
                      height: 154.h,
                      width: 154.w,
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: TextButton(
                          ...
                          child:
                              Text("Scan", style: CustomizedTheme.w_W500_19)),
                    ),
                  ),
                ],
              ),
              ...
              Padding(
                padding: EdgeInsets.only(top: 29.h, bottom: 42.h),
                child: Row(
                  children: [
                    Expanded(
                      child: Container(
              ...
              Form(
                ...
                child: TextFormField(
                  decoration: InputDecoration(
                    ...
                    labelText: "Emirates ID/Passport",
              ...
              Padding(
                padding: EdgeInsets.only(top: 50.75.h, bottom: 40.93.h),
                child: Row(
                  children: [
                    Expanded(
                      child: Container(
