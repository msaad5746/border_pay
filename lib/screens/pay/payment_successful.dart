                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text('Payment  Successful',style: CustomizedTheme.sf_b_W600_2487),
                        ),
                        Padding(
                          padding: const EdgeInsets.only(bottom: 6.29),
                          child: Text('Exit Fee paid',style: CustomizedTheme.sf_b_W300_14),
                        ),
                      ],
                    ),
                  ),
          ...
          Expanded(
            child: SingleChildScrollView(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.only(top: 37.63,bottom: 28,right: 20.36,left: 20.36),
                    child: Text('Payment Voucher',style: CustomizedTheme.popp_b_W500_23,),
                  ),
                  Center(child: Column(
                    children: [
                      Text('Scan QR Code to view payment receipt ',style:CustomizedTheme.sf_bo_W400_15),
                      Padding(
                        padding: const EdgeInsets.only(top: 26,bottom: 39.83),
                        child: QrImage(
                          data: "1234567890",
                  ...
                  Padding(
                    ...
                    child: ListView(
                      ...
                      children: [
                        ListTile(
                          leading: Text('Receipt Number',style: CustomizedTheme.sf_bo_W300_1503),
                          trailing: Text('76765421',style: CustomizedTheme.sf_bo_W500_1503),
                        ),
                        ListTile(
                        ...
                        ClipRRect(
                          ...
                          child: ExpansionTile(
                            title: Text("3",style: CustomizedTheme.sf_bo_W500_1503),
                            childrenPadding: const EdgeInsets.symmetric(horizontal: 15,vertical: 6),
                        ...
                        ListTile(
                          ...
                          trailing: Text('AED 105.25',style: CustomizedTheme.sf_bo_W500_1503),
                        ),
                        ListTile(
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: TextButton(onPressed: () {Navigator.pushNamed(context, '/payment_refund');},
                          child: Text("Refund Payment",style: CustomizedTheme.w_W500_19)),
                    ),
                  ),
                ],
              ),
